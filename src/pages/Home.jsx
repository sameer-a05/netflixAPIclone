            ...
            <div className="movie__list">
              ...
              <div className="movie">
                <figure className="movie__img--wrapper">
                  <img src={Poster1} alt="Guardians of the Galaxy Vol 2" className="movie__img" />
              ...
              <div className="movie">
                <figure className="movie__img--wrapper">
                  <img src={Poster3} alt="Spider-Man: Homecoming" className="movie__img" />
                  <div className="movie__overlay">
                    <h3 className="movie__info--title">Spider-Man: Homecoming</h3>
              ...
              <div className="movie">
                <figure className="movie__img--wrapper">
                  <img src={Poster4} alt="Minions: Rise of Gru" className="movie__img" />
                  <div className="movie__overlay">
              ...
              <div className="movie">
                <figure className="movie__img--wrapper">
                  <img src={Poster5} alt="Spider-Man: Into the Spider-Verse" className="movie__img" />
                  <div className="movie__overlay">
                    <h3 className="movie__info--title">Spider-Man: Into the Spider-Verse</h3>
